...
+ \begin{bmatrix}v_1\\ v_2\\ v_3\end{bmatrix},
 \textrm{ } \vv_t \sim \MVN\begin{pmatrix}\begin{bmatrix}0\\0\\0\end{bmatrix},\begin{bmatrix}r&0&0\\0&r&0\\0&0&r\end{bmatrix} \end{pmatrix}
 \end{gathered}
(\#eq:short-mrw1)
\end{equation}
...
+ \begin{bmatrix}w_1\\ w_2\\ w_3\end{bmatrix},
 \textrm{ } \ww_t \sim \MVN\begin{pmatrix}\begin{bmatrix}0\\0\\0\end{bmatrix},
...
Look at the $\QQ$. Hood Canal (HC) appears to be behaving independently.
```{r}
...
So far we have been assuming that the observations errors, $\vv_t$, are temporally independent. Let's assume 3 observations of one underlying trend but assume the observations have AR(1) errors. We'll assume that the variance of those error is correlated across the first 2 time series and they have the same level of autocorrelation ($b$). We'll treat the 3rd time series as independent.

To do this, we need to move the observation errors into the $\xx$ part of the MARSS model and we need to add the $\BB$ matrix for the AR(1) feature. Notice that the $\yy$ equation does not have $\vv_t$ since the observation errors are specified in the $\xx$ part of the equation and are flowing from $\xx$ to $\yy$ via $\ZZ$.
\begin{equation}
\begin{gathered}
...
+ \begin{bmatrix}w_1\\ w_2\\ w_3 \\ w_4\end{bmatrix},
 \textrm{ } \ww_t \sim \MVN\begin{pmatrix}
 \begin{bmatrix}0\\0\\0\end{bmatrix},
 \begin{bmatrix}
 q_1&0&0&0\\
 0&q_2&c&0\\
...
+ \begin{bmatrix}w_1\\ w_2\end{bmatrix},
 \textrm{ } \ww_t \sim \MVN\begin{pmatrix}\begin{bmatrix}0\\0\end{bmatrix},
...
+ \begin{bmatrix}0\\0\\0\\0\\0\end{bmatrix}
+ \begin{bmatrix}v_1\\ v_2\\ v_3 \\ v_4 \\ v_5\end{bmatrix},
 \textrm{ } \vv_t \sim \MVN\begin{pmatrix}\begin{bmatrix}0\\0\\0\\0\\0\end{bmatrix},
 \begin{bmatrix}
 r&0&0&0&0\\
 0&r&0&0&0\\
 0&0&r&0&0\\
